    ...
    public class DependencySummarizerTest extends BaseReportingAbiInspectorTest {
        ...
        public void setUp( ) throws Exception {
            ...
            this.bitcoinj = this.finder.findInCache(  bitcoinjGAV ).orElse( this.artifact4Path ).toFile( );
            this.protobuf = this.finder.findInCache(  protobufGAV ).orElse( this.artifact9Path ).toFile( ); 
            this.classesDir = new JarFile( this.bitcoinj );
            this.aDependency = new JarFile( this.protobuf );
        ...
        public void testEnterCalledNTimesReturnsSameFrequency( ) {
            ...
            Set<Class<?>> classes = classify( this.classesDir );
            ...
            classes = classify( this.aDependency );
